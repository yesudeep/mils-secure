...
class UsersHandler(webapp.RequestHandler):
    def get(self):
        response = render_template('admin/generic_list.html', page_name='users', page_description='Approving, editing, and sending messages to users is easy.  Just click on a name to perform any of these operations.')
        self.response.out.write(response)
